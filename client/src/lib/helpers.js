...
const englishTexts = {
    ...
    answer4: 'It might take a while until people realize that the sell price is at all times the minimum sell price which will never go below the current value expressed in Matic - even in a "bankrun" like situation. <p><br /></p> If you find any serious catch, please raise an issue <a href="https://github.com/FreiheitsGeld/freiheitsgeld/issues/new" target="_blank">here</a>.',
